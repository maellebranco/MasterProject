...
{
    VideoCapture cap("/home/maelle/Desktop/Samples/Static/"+folderName+"/"+videoName+".avi");  // open the original video
    ...
    VideoWriter videoWriter("/home/maelle/Desktop/Samples/Static/"+folderName+"/"+stableVideoName+".avi",fourcc,fps,frameSize,true);  // initialize the VideoWriter object
